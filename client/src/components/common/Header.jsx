      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            {/* Desktop Navigation */}
            <nav className="hidden lg:flex flex-row items-center space-x-1">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/30 flex items-center space-x-2 lg:hidden"
              >
              ...
              {/* Mobile Menu Button */}
              <button
                className="p-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-all duration-300 hover:scale-105 lg:hidden"
                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              >
                <div className="w-6 h-6 flex flex-col justify-center items-center space-y-1">
                  <div
                    className={`w-5 h-0.5 bg-blue-950 transition-all duration-300 ${
              ...
              <button
                onClick={() => (window.location.href = "/login")}
                className="ml-4 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/30 items-center space-x-2 hidden lg:flex"
              >
                <span>เข้าสู่ระบบ</span>
                <span className="transform group-hover:translate-x-1 transition-transform">
                  →
        ...
        >
          <div className="bg-white/95 backdrop-blur-xl border-t border-gray-200/50">
            <nav className="container mx-auto px-4 py-6 flex flex-wrap justify-center gap-x-4 gap-y-2">
              {navItems.map((item, index) => (
                <a
                  key={item.name}
                  href={item.href}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex items-center space-x-2 px-3 py-2 rounded-xl text-gray-600 hover:text-blue-950 hover:bg-blue-500/5 transition-all duration-300 group text-sm"
